...
describe('Service Tests', () => {
    describe('UserType Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(UserTypeService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/user-types';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a UserType', () => {
                service.create(new UserType(null)).subscribe(received => {
            ...
            it('should update a UserType', () => {
                service.update(new UserType(123)).subscribe(received => {
